...
from deep_compression import losses
from deep_compression import layers
...
def create_generators(args):
    ...
    if args.dataset_type == 'coco':
        ...
        #print("args.val_annotations: ", args.val_annotations)
...
def parse_args(args):
    ...
    parser.add_argument('--epochs',          help='Number of epochs to retrain.', type=int, default=10)
    parser.add_argument('--steps',           help='Number of steps per epoch.', type=int, default=10000)
    parser.add_argument('--model',           help='path of model.')
    parser.add_argument('--retrain',         help='Number of times to retrain.', type=int, default=1)
...
def main(args=None):
    ...
    for i in range(args.retrain):
        print i, ".th retrain is starting"
